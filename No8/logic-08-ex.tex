...
\item 以下の論理プログラム$P$に対し，
  ...
  $\{\}$                 & \begin{tabular}[c]{@{}l@{}}$wake\Leftarrow coffe$\\ $wake \Leftarrow tea$\\ $tea \Leftarrow $ \\ $coffe \Leftarrow$\end{tabular} & $\{walk, tea, coffe\}$ & $No$                \\ \hline
  $\{W\}$                & \begin{tabular}[c]{@{}l@{}}$wake\Leftarrow coffe$\\ $wake \Leftarrow tea$\\ $tea \Leftarrow $ \\ $coffe \Leftarrow$\end{tabular} & $\{walk, tea, coffe\}$ & $No$                \\ \hline
  $\{tea\}$              & \begin{tabular}[c]{@{}l@{}}$wake\Leftarrow coffe$\\ $wake \Leftarrow tea$\\ $tea \Leftarrow $\end{tabular}                       & $\{walk, tea\}$        & $No$                \\ \hline
  $\{coffe\}$            & \begin{tabular}[c]{@{}l@{}}$wake\Leftarrow coffe$\\ $wake \Leftarrow tea$\\ $coffe \Leftarrow$\end{tabular}                      & $\{walk, coffee\}$     & $No$                \\ \hline
  $\{walk, tea\}$        & \begin{tabular}[c]{@{}l@{}}$wake\Leftarrow coffe$\\ $wake \Leftarrow tea$\\ $tea \Leftarrow $\end{tabular}                       & $\{walk,tea\}$         & $Yes$               \\ \hline
  $\{walk, coffe\}$      & \begin{tabular}[c]{@{}l@{}}$wake\Leftarrow coffe$\\ $wake \Leftarrow tea$\\ $coffe \Leftarrow$\end{tabular}                      & $\{walk,coffee\}$      & $Yes$               \\ \hline
  $\{tea, coffe\}$       & \begin{tabular}[c]{@{}l@{}}$wake\Leftarrow coffe$\\ $wake \Leftarrow tea$\end{tabular}                                           & $\{walk\}$             & $No$                \\ \hline
  $\{walk, tea, coffe\}$ & \begin{tabular}[c]{@{}l@{}}$wake\Leftarrow coffe$\\ $wake \Leftarrow tea$\end{tabular}                                           & $\{walk\}$             & $No$ \\ \hline
  \end{tabular}
  \end{table}
より、安定モデル$S = \{walk, tea\}, \{walk, coffee\}$。
